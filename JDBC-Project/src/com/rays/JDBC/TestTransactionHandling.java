...
public class TestTransactionHandling {
	public static void main(String[] args) throws SQLException {
		...
		try {
			...
			int i = stmt.executeUpdate("insert into marksheet values(26, 'mihir', 67, 89, 76, 87, 98)");
			i = stmt.executeUpdate("insert into marksheet values(27, 'mihir', 67, 89, 76, 87, 98)");
